    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <nav className="px-[6%] py-5 flex items-center justify-between border-b-2 border-primary text-foreground sticky top-0 bg-white/90 backdrop-blur-md z-[100]">
        ...
        <div className="flex gap-3">
          <Link to="/admin"><Button variant="ghost" className="font-bold text-slate-500">취소</Button></Link>
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <Tabs defaultValue="basic" className="w-full space-y-8">
          ...
          <TabsList className="grid grid-cols-4 w-full h-auto p-1 bg-slate-200/50 sticky top-[84px] z-[90] shadow-sm">
            <TabsTrigger value="basic" className="py-3 font-black text-xs uppercase tracking-tighter data-[state=active]:bg-white data-[state=active]:text-primary">
              기본 정보 / 소개
            </TabsTrigger>
            <TabsTrigger value="career" className="py-3 font-black text-xs uppercase tracking-tighter data-[state=active]:bg-white data-[state=active]:text-primary">
              커리어 (Career)
            </TabsTrigger>
            <TabsTrigger value="media" className="py-3 font-black text-xs uppercase tracking-tighter data-[state=active]:bg-white data-[state=active]:text-primary">
              화보 / 아카이브
            </TabsTrigger>
            <TabsTrigger value="data" className="py-3 font-black text-xs uppercase tracking-tighter data-[state=active]:bg-white data-[state=active]:text-primary">
              데이터 / 수상
            </TabsTrigger>
          </TabsList>
        ...
        <div className="mt-20 pt-10 border-t-4 border-slate-900 flex flex-col items-center gap-4">
           <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">모든 탭의 수정사항이 한꺼번에 저장됩니다.</p>
           <Button 
            onClick={handleSave} 
            disabled={saving} 
